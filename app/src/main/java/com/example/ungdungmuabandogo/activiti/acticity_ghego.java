...
public class acticity_ghego extends AppCompatActivity {
    ListView listView;
    ...
    private void GetData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Sever.Duongdanghego, new Response.Listener<String>() {
            @Override
