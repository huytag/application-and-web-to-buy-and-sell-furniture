...
public class activity_banthogo extends AppCompatActivity {
    ListView listView;
    ...
    private void GetData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Sever.Duongdanbantho, new Response.Listener<String>() {
            @Override
