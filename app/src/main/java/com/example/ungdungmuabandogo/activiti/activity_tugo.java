...
public class activity_tugo extends AppCompatActivity {
    ListView listView;
    ...
    private void GetData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Sever.Duongdantugo, new Response.Listener<String>() {
            @Override
