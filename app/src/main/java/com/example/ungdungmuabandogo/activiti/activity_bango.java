...
public class activity_bango extends AppCompatActivity {
    ListView listView;
    ...
    private void GetData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Sever.Duongdanbango, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if (response !=null && response.length() != 2){
                    ...
                    Checkconnecttion.showToast_Short(getApplicationContext(),"đã hết dữ liệu");
                }
            }
