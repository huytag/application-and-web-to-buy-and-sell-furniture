...
public class activity_tongquansuamathang extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tongquansuamathang);
        Anhxa();
    ...
    private void Chitietsanpham() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(), activity_suamathang.class);
                intent.putExtra("tongquanmathangsua", mangbg.get(position));
    ...
    private void ActionTooolbar() {
        ...
        toolbar.setTitle("Tổng quan mặt hàng SỬA");
