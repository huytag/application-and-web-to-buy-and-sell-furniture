...
<html>
<head>
	<title>Quản trị web mua bán đồ gỗ</title>
	<meta charset="utf-8">
...
<!-- Thanh navbar -->
	<nav class="navbar navbar-expand-sm bg-dark justify-content-center navbar-dark" >
  			...
  			<ul class="navbar-nav">
    			<li class="nav-item">
      				<a class="nav-link" href="http://localhost:8080/web/getbango.php">Bàn gỗ</a>
    			</li>
    			<li class="nav-item">
		    ...
		    <li class="nav-item dropdown">
		      ...
		      <div class="dropdown-menu">
		        ...
		        <a class="dropdown-item" href="http://localhost:8080/web/themsanpham.php">Quản lý sản phẩm</a>
		        <a class="dropdown-item" href="http://localhost:8080/web/index.php">Logout</a>
		      </div>
		    </li>
		  </ul>
  	</nav>
